                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Spacing.vLarge,
                                SummaryCard(
                                  title: "Total Banked today",
                                  amount: dashboardModel.totalAmountPaidToday,
                                  lastDayLabel:
                                      "Note: Please note that this is manual entry and not persisted in database",
                                  icon: Icons.edit,
                                  onPressed: () {
                                    showDialog(
                                      context: context,
                                  ...
                                  children: [
                                    PieChart(
                                      fleetIncome: FleetIncomeModel(
                                        ...
                                        totalFleetAmtForChart: dashboardModel
                                    ...
                                    IncomeBarChart(
                                      values:
                                          dashboardModel.monthlyFleetIncomes,
